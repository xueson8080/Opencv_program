...
int main(int argc, char** argv) {
    ...
    // // 中值模糊
    medianBlur(src, meblur_ima, 5);
    namedWindow("meblur_ima", 1);
    imshow("meblur_ima",meblur_ima);


    cvtColor(meblur_ima, gray_src, CV_BGR2GRAY);
    ...
    // // // imwrite("road/straight_2.jpg", process_image);
...
// 	// 	}
// 	// }
//     printf("process_image channels:%d\n", process_image.channels());
//     printf("process_image rows:%d\n", process_image.rows);
//     printf("process_image cols:%d\n", process_image.cols);
// /***********************************************************************/
